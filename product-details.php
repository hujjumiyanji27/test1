...
if(isset($product)) {
    ...
    if (!empty($reviews)) {
        ...
        foreach ($reviews as $review) {
          ...
          $total_rating += $review['review_rating']; // Add rating to total rating
        }
        
        $average_rating = round($total_rating / count($reviews), 1); // Calculate average rating
        
        echo '<p>Average Rating: ' . $average_rating . '/5</p>'; // Display average rating
